...
export default function ExternalHandle() {
    ...
    return (
        <div className="config-variable"><label>Public Access
            <FormSelectDropdown label="External Handle" formKey={`${baseFormKey}.externalhandle`} options={[
        ...
        </label><LinkButton text={"Copy Mod URL"} mode="copy" link={externalHTTPUrl + "/mod"} /></div>
    )
}