...
import ColorEditor from '../Common/ColorEditor.js';
  ...
  resetTheme() {
    ...
    this.setState(
      Object.assign(this.state, {
        currentTheme: Object.assign(this.state.currentTheme, this.state.resetStyle),
        editTime: Date.now(),
      }),
    );
  }
        ...
        if (style == '--app-background-image') {
          colors.push(
            <label>
              ...
              <input
                type='text'
                defaultValue={currentStyle[style]}
                onInput={(e) => this.updateVar(style, e.currentTarget.value)}
              />
            </label>,
          );
        } else {
          colors.push(
            <label>
              {style}
              <ColorEditor
                key={style + '-' + this.state.editTime}
                inputStyle={currentStyle[style]}
                cssvarname={style}
                onColorChanged={this.updateVar}
              />
            </label>,
          );
        }
      ...
      return (
        <div className='theme-editor'>
          ...
          <div className='theme-editor-actions'>
            <button className='modcheck-button' onClick={this.saveTheme}>
              Save
            </button>
            <button className='modcheck-button' onClick={this.state.syncTheme}>
              Sync
            </button>
            <button className='modcheck-button' onClick={this.resetTheme}>
              Reset
            </button>
          </div>
        </div>
